...
const RecipesGlutenFree = () => {
  ...
  const defaultSearchURL = `https://api.edamam.com/api/recipes/v2?type=public&time=1%2B&dishType=Main%20course&app_id=${appID}&app_key=${appKey}&health=gluten-free`
...
export default RecipesGlutenFree